...
bin/asmjs/%.bc: %.cpp
	em++ $(EMXXFLAGS) -emit-llvm -D=GLES2 -DUSE_SDL_IMAGE -std=c++14 -O3 -c -o $@ $<
...
bin/gles3/inf_demo.exe: $(GLES3_OBJECTS)
...
bin/asmjs/inf_demo.html: $(ASMJS_OBJECTS)
	em++ -$(EMXXFLAGS) $(ASMJS_OBJECTS) gloopcpp/bin/asmjs/libGLOOP.bc -o $@ `
